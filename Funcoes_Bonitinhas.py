...
lista_musicas = coletar_nomes_musicas("https://www.letras.com/pink-floyd/")
...
ser_album_musica = discografia("https://www.letras.mus.br/pink-floyd/discografia/", "Serie musica")
ser_album_data = discografia("https://www.letras.mus.br/pink-floyd/discografia/", "Serie data")
print(ser_album_data)
tupla_album_musica = discografia("https://www.letras.mus.br/pink-floyd/discografia/", "tupla")
ser_musica_tempo = tempo_musica()
print(ser_musica_tempo)
...
print(df_index_album)
print(df_index_musicas)
indices = pd.MultiIndex.from_tuples(tupla_album_musica, name=("Álbum", "Música"))
